...
//make connection with ipfs
const client = ipfsHttpClient('https://ipfs.infura.io:5001/api/v0');

import {
    nftAddress, nftMarketAddress
} from '../config';
import NFT from '../artifacts/contracts/CollectibleNFT.sol/CollectibleNFT.json';
...
export default function CreateItem() {
    ...
    async function createItem() {
        ...
        //*******************store the created nft on database**********************************//
        //*******************create list NFT function**********************************//
        try {
    ...
    async function createSale(url) {
        ...
        //get the listing price nftAddress, nftMarketAddress
